...
export const UserComment = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.userComment.totalItems);
  ...
  return (
    <div>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="camprApp.userComment.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('commentBody')}>
                  <Translate contentKey="camprApp.userComment.commentBody">Comment Body</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('commentDate')}>
                  <Translate contentKey="camprApp.userComment.commentDate">Comment Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="camprApp.userComment.appUser">App User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="camprApp.userComment.video">Video</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
      ...
      {totalItems ? (
        <div className={userCommentList && userCommentList.length > 0 ? '' : 'd-none'}>
