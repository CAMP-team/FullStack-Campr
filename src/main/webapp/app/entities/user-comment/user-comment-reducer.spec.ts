...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERCOMMENT actions', async () => {
      const expectedActions = [
        {
