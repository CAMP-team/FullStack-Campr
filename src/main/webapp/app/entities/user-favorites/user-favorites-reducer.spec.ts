...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERFAVORITES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERFAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERFAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERFAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERFAVORITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERFAVORITES actions', async () => {
      const expectedActions = [
        {
