...
export const UserUpload = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.userUpload.totalItems);
  ...
  return (
    <div>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="camprApp.userUpload.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dateUploaded')}>
                  <Translate contentKey="camprApp.userUpload.dateUploaded">Date Uploaded</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="camprApp.userUpload.appUser">App User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
      ...
      {totalItems ? (
        <div className={userUploadList && userUploadList.length > 0 ? '' : 'd-none'}>
