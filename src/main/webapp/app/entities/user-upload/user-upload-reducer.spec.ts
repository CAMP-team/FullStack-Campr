...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERUPLOAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERUPLOAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERUPLOAD actions', async () => {
      const expectedActions = [
        {
