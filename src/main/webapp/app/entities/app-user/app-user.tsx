        ...
        {appUserList && appUserList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="camprApp.appUser.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="camprApp.appUser.internalUser">Internal User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="camprApp.appUser.home.notFound">No App Users found</Translate>
            </div>
          )
        )}
      </div>
