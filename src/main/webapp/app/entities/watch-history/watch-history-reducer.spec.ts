...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATCHHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_WATCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WATCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WATCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WATCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WATCHHISTORY actions', async () => {
      const expectedActions = [
        {
